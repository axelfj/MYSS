...
function connect(){
    try{
        $connectionOptions = [
            ...
            ArangoConnectionOptions::OPTION_ENDPOINT => 'tcp://104.198.143.130:8529', // server endpoint to connect to
            ...
            ArangoConnectionOptions::OPTION_AUTH_PASSWD => 'admin123*', // password for basic authorization
