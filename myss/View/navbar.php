...
<header class="">
    <nav class="navbar navbar-expand-lg navbar-light bg-light static-navbar justify-content-end">
        <a class="navbar-brand" style="color:rgb(56, 164, 255);padding-left:100px;" href="index.php" onmouseover="this.style.color='rgb(0, 138, 255)';" onmouseout="this.style.color='rgb(56, 164, 255)'">MYSS</a>
        ...
        <div class="collapse navbar-collapse flex-grow-0 ml-auto" id="navbarSupportedContent">
            <ul class="navbar-nav text-right" style="padding-right:100px;">
                <li class="nav-item">
                    <a class="nav-link" href="#" onmouseover="this.style.color='rgb(56, 164, 255)'" onmouseout="this.style.color='';">
                        <i class="fas fa-plus" >
